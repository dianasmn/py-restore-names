...
def user_template() -> Dict[str, List[Dict[str, Any]]]:
    ...
    return {
        "already_set": [
            {"first_name": "Emma", "last_name": "Stone", "full_name": "Emma Stone"}
        ],
        "none_first": [
...
def test_first_name_already_set(user_template: Dict[str, List[Dict[str, Any]]]) -> None:
...
def test_first_name_none_first(user_template: Dict[str, List[Dict[str, Any]]]) -> None:
...
def test_first_name_missing(user_template: Dict[str, List[Dict[str, Any]]]) -> None:
